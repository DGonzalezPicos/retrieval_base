...
free_params = {
    ...
    # SPHINX
    'Teff': [(2700.0, 4000.0), r'$T_\mathrm{eff}$'], # Teff = 4005 +- 51 (GonzalezAlvarez+2020)
    'log_g': [(4.5,5.5), r'$\log\ g$'], # logg = 4.68 +- 0.07 (GonzalezAlvarez+2020)
    'Z': [(-0.25, 0.25), 'Z'], # Z = -0.03 +- 0.16 (GonzalezAlvarez+2020)
    # 'C_O': [(0.3, 0.9), 'C/O'],
