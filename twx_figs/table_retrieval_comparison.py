...
def main():
    ...
    replace_names = {
        ...
        'T_d' : '$T^{\\text{bb}}_{\\text{eff}} / \\text{K}$',
        'log_R_d' : '$\\log R^{\\text{bb}} / R_{\\text{jup}}$',
        'log_R_jup' : '$\\log R^{\\text{slab}} / R_{\\text{jup}}$',
        'log_T_ex' : '$\\log T^{\\text{slab}}_{\\text{ex}} / \\text{K}$',
        'log_N_mol' : '$\\log N^{\\text{slab}}_{\\text{mol}} / \\text{cm}^{-2}$',
        'log_Hminus' : '$\\log \\text{H}^{-}$',
        'rv' : '$v_{\\text{rad}} / \\text{km s}^{-1}$',
        'rv_disk' : '$v^{\\text{slab}} / \\text{km s}^{-1}$',
